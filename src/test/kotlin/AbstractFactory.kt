...
class AbstractFactoryTest {
    ...
    fun aftest() {
        ...
        val network = networkDataSourceFactory.makeDataSource()
        println("Created datasource: $network")

        Assertions.assertThat(network).isInstanceOf(NetworkDataSource::class.java)
    }
}